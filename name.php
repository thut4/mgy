        ...
        <div class="row justify-content-center">
            <div class="col-8  mt-4 shadow p-3 mb-5 bg-white rounded">
                ...
                <ul class="list-unstyled text-right">
                    ...
                    <li class="text-info">Order From HighClass=<?php echo rowCount($pdo, "SELECT * FROM `customer_info` WHERE restaurant='MiSo'") ?></li>
                    <li class="text-info">Order From HighClass=<?php echo rowCount($pdo, "SELECT * FROM `customer_info` WHERE restaurant='YoeShin'") ?></li>
                </ul>
                <hr>
                <?php if ($results) : ?>
